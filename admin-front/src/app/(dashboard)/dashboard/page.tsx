      ...
      {store ? (
        <>
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            {[
              { label: "Orders", value: "--", color: "text-primary-600 bg-primary-50" },
              { label: "Revenue", value: "--", color: "text-green-600 bg-green-50" },
              { label: "Customers", value: "--", color: "text-blue-600 bg-blue-50" },
              { label: "Products", value: "--", color: "text-violet-600 bg-violet-50" },
            ].map(({ label, value }) => (
          ...
          <Card>
            ...
            <div className="space-y-2.5">
              {[
                { label: stores.length > 0 ? "Create your store" : "Create your first store", done: stores.length > 0 },
